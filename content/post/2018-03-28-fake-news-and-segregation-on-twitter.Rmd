...
The punchline is **only 5% of the followers of @FlatEarthOrg are also the followers of @NASA!!** If they believe that the earth is flat, basically they are not interested in what NASA would say about the universe.

The largest intersecting set is between `@FlatEarthOrg` and `@FlatEarthToday`. The followers are hightly overlapped. But among the followers of `@FlatEarthOrg`, only 2373 are the followers of `@NASA`. 
